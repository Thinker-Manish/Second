...
public class Shoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoes); // Replace with your actual layout
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (i < shoeImages.length && imageView != null && textView != null) {
                ...
                cardView.setOnClickListener(v -> {
                    ...
                    Intent intent = new Intent(Shoes.this, ProductActivity.class);
                    ...
                    Toast.makeText(Shoes.this, productName + " Clicked", Toast.LENGTH_SHORT).show();
                });
            }
        }
    }
